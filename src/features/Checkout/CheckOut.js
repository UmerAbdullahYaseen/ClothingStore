            ...
            <div className="mx-auto max-w-lg px-4 lg:px-8">
              <form className="grid grid-cols-6 gap-4">
                ...
                <fieldset className="col-span-6">
                  ...
                  <div className="mt-2 -space-y-5px  bg-white shadow-sm">
                    <div>
                      ...
                      <input
                        ...
                        className="relative mt-1 w-full  border-gray-200 focus:z-10 sm:text-sm"
                      />
                    </div>
                    ...
                    <div className="flex mt-2">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className="relative w-full  border-gray-200 focus:z-10 sm:text-sm"
                        />
                      </div>
                  ...
                  <div className="mt-1 -space-y-px  bg-white shadow-sm">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="city"
                        placeholder="City"
                        className="relative w-full mt-5 border-gray-200 focus:z-10 sm:text-sm"
                      />
                    </div>
                    <div>
                      <label className="sr-only" htmlFor="PostalCode">
                    ...
                    <div>
                      <label className="sr-only" htmlFor="PostalCode"></label>
                ...
                <div className="col-span-6">
                  <button className="mt-5 block w-full text-lg bg-black p-2.5  text-white transition hover:shadow-lg">
                    Pay and Order Now
                  </button>
                </div>
              </form>
